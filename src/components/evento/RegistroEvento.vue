    ...
    import Multiselect from 'vue-multiselect'
	 ...
	 export default {
        ...
        methods: {
            ...
            cargarServicios(){
                axios.get('https://servidor-sats.herokuapp.com/api/servicio/lista-servicios', {
                params: {
                    }
                })
        		.then((res)=>{
            ...
            cargarTiposEventos(){
                axios.get('https://servidor-sats.herokuapp.com/api/evento/lista-tipos-eventos', {
                params: {
                    }
                })
        		.then((res)=>{
            ...
            registrarEvento(){
                ...
                if(this.checkForm()){
                    ...
                    axios.post('http://localhost:4567/api/evento/agregar-evento', params) 
                        .then((res)=>{
