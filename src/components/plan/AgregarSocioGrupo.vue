            ...
            <div class="card-body darkTextCustom">
                <form v-on:submit.prevent="registrarSocio()">
                    ...
                    <div v-if="planes.length" class="form-group">
                        ...
                        <select id="planes" class="form-control" v-model="cliente.sociedad.plan.id" disabled="true">
                    ...
                    <input type="submit" :disabled="disabled" value="Asociar" class="btn marginBefore btn-success">
                </form>
            </div>
        </div>
    </div>
